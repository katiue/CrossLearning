  ...
  return (
    <div className="max-w-6xl mx-auto p-6">
      <h1 className="text-3xl font-bold mb-6 flex items-center gap-2">
        <FileText className="w-8 h-8 text-primary" /> Teacher Notes
      </h1>
      ...
      {error && (
        <div className="flex items-center justify-center gap-2 p-4 mb-6 bg-[color-mix(in_srgb,var(--destructive)_10%,transparent)] text-destructive border border-destructive rounded-lg">
